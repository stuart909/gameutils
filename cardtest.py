...
#This is a game playing card creator for Savage Worlds Freedom Squadron.
#I do not own the IP for Freedom Squadron.
#THIS SOFTWARE DOES NOT GRANT YOU THE RIGHT TO CREATE AND DISTRIBUTE FREEDOM SQUADRON PLAYING CARDS.
#THIS IS FOR PERSONAL USE ONLY
#This software will take a full path and image name for an input card, typically 400x600 pixels in png format
#This software also requires an output file destination.
#There is primitive error handling to prevent bad paths or file errors.  Q will quit.
#This will apply some Freedom Squadron style rule sets on top of the image and create a playing card.
